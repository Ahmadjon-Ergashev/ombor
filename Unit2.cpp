...
nomi = DBEdit1->Text; turi = DBEdit2->Text;
eni = DBEdit3->Text; boyi = DBEdit4->Text;
soni = DBEdit5->Text; m_narxi = DBEdit6->Text;
...
if (!Form4->ADOQuery1->Eof){
	...
	Form4->ADOQuery1->FieldByName("Soni")->AsInteger = Form4->ADOQuery1->FieldByName("Soni")->AsInteger + StrToInt(soni);
	...
	Form4->ADOQuery1->FieldByName("Summasi")->AsString = eni*boyi*m_narxi*soni;
	Form4->ADOQuery1->Post();
	}
